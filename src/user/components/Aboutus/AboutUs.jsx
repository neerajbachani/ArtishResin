          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                <span className="block mb-4 ml-2 text-xl font-bold text-primarycolor">
                  Why Choose Us?
                </span>
                <h2 className="mb-5 md:text-3xl text-lg mx-2 md:mx-0  font-semibold text-secondary-dark-color dark:text-white sm:text-[40px]/[48px] font-poppins ">
                ...
                <div id="nav-part2" className=' flex justify-center items-center text-center text-sm ' >
                    <Link to='/signup'><h4 className=' px-[12px] py-[6px] ' ><a className='text-sm' href="/signup">All About Us</a></h4></Link>
                    </div>
