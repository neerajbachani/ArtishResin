...
<div className=' flex justify-between mt-5 ' >
  ...
  className="flex items-center bg-white text-gray-800 p-2 px-4 rounded-full border-2 border-gray-300 hover:bg-green-600 hover:border-green-600 hover:text-white transition-colors duration-300"
>
  <FaWhatsapp className="text-xl sm:text-xl mr-2 text-green-600" />
  <span className="text-green-600 font-semibold group-hover:text-white transition-colors duration-300">WhatsApp</span>
</button>
