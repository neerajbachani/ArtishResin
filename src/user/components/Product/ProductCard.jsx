    ...
    <div className="group overflow-hidden rounded-lg bg-gray-50 shadow-md transition-all duration-300 hover:shadow-xl">
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-40 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
          <button
            onClick={() => eyeHandler(_id)}
            className="mr-2 rounded-full bg-white p-2 text-gray-800 transition-colors duration-300 hover:bg-black hover:text-blue-300"
          >
            <Eye size={20} />
          </button>
          <button
            onClick={() => handleWhatsAppClick(_id)}
            className="rounded-full bg-white p-2 text-gray-800 transition-colors duration-300 hover:bg-green-600 hover:text-white"
          >
