    ...
    <>
      <div className="relative max-w-screen-2xl mx-auto mt-[5rem]">
        ...
        <div className=' absolute bottom-[2%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 '>
            <button className=' text-white bg-[#2e9eff] hover:bg-black hover:text-[#BDE0FE] transition duration-500 ease-in-out text-xl rounded-xl font-poppins px-5 py-2 '>Join Our Workshop</button>
        </div>
