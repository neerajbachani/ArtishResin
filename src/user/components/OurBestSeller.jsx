      ...
      <div className="flex sm:flex-nowrap flex-wrap justify-center mt-[2rem] lg:gap-8 gap-5">
        ...
        {ourBestSellerProduct?.ourBestSellerProducts?.map((product) => (
          ...
          <div class="h-min overflow-hidden rounded-md">
            <img
              src={product.image}
              className="lg:w-[12rem] hover:scale-125 transition-all duration-500 cursor-pointer lg:h-[12rem] md:w-[25rem] md:h-[20rem] sm:w-[20rem] sm:h-[15rem] w-[10rem] h-[10rem] object-cover"
              alt={product.title}
            />
            </div>
