  ...
  return (
    <Box sx={{ backgroundColor: "#121212", minHeight: "100vh", padding: "2rem" }}>
      ...
      <BestSellerProductsTable
        bestSellerProducts={ourBestSellerProduct?.ourBestSellerProducts}
        onDelete={handleDeleteOurBestSellerProduct}
      />
    </Box>
  );
};

const BestSellerProductsTable = React.memo(({ bestSellerProducts, onDelete }) => (
  <Box width="100%" mt={4}>
